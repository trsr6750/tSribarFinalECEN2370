...
#define LCD_COLOR_BCKRND		0x114F
...
#define LCD_GAME_HEIGHT ((uint16_t) 320)
#define LCD_GAME_WIDTH ((uint16_t) 160)
#define LCD_GAME_START_X ((uint16_t) 40)
#define LCD_GAME_START_Y ((uint16_t) 0)
#define LCD_GAME_END_X ((uint16_t) 200)
#define LCD_GAME_END_Y ((uint16_t) 320)
